                    ...
                    <div class="card-body p-0">
                        <div class="tab-content" id="materialTabContent">
                            ...
                            <div class="tab-pane fade" id="content-penyangga" role="tabpanel">
                                ...
                                @php
                                    $totalPenyangga = isset($calculation) ? collect($calculation->details)->where('section', 'Penyangga')->sum('subtotal_price') : 0;
                                @endphp
                                @if($totalPenyangga > 0)
                                <div class="p-3 bg-light d-flex justify-content-end tab-footer border-top">
                                    <div class="card-summary-premium p-3" style="width: 350px;">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span class="text-navy fw-bold text-uppercase" style="font-size: 12px; letter-spacing: 0.5px;">Total Biaya Penyangga</span>
                                            <span class="fs-5 fw-black text-primary">Rp {{ number_format($totalPenyangga, 0, ',', '.') }}</span>
                                        </div>
                                    </div>
                                </div>
                                @endif
                            ...
                            <div class="tab-pane fade" id="content-penutup" role="tabpanel">
                                ...
                                @php
                                    $totalPenutup = isset($calculation) ? collect($calculation->details)->where('section', 'Penutup')->sum('subtotal_price') : 0;
                                @endphp
                                @if($totalPenutup > 0)
                                <div class="p-3 bg-light d-flex justify-content-end tab-footer border-top">
                                    <div class="card-summary-premium p-3" style="width: 350px;">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span class="text-navy fw-bold text-uppercase" style="font-size: 12px; letter-spacing: 0.5px;">Total Biaya Penutup</span>
                                            <span class="fs-5 fw-black text-primary">Rp {{ number_format($totalPenutup, 0, ',', '.') }}</span>
                                        </div>
                                    </div>
                                </div>
                                @endif
                            ...
                            <div class="tab-pane fade" id="content-bawah" role="tabpanel">
                                ...
                                @php
                                    $totalBawah = isset($calculation) ? collect($calculation->details)->where('section', 'Bawah')->sum('subtotal_price') : 0;
                                @endphp
                                @if($totalBawah > 0)
                                <div class="p-3 bg-light d-flex justify-content-end tab-footer border-top">
                                    <div class="card-summary-premium p-3" style="width: 350px;">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span class="text-navy fw-bold text-uppercase" style="font-size: 12px; letter-spacing: 0.5px;">Total Biaya Bawah</span>
                                            <span class="fs-5 fw-black text-primary">Rp {{ number_format($totalBawah, 0, ',', '.') }}</span>
                                        </div>
                                    </div>
                                </div>
                                @endif
                            ...
                            <div class="tab-pane fade" id="content-additional" role="tabpanel">
                                ...
                                @php
                                    $totalAdditional = isset($calculation) ? collect($calculation->details)->where('section', 'Additional')->sum('subtotal_price') : 0;
                                @endphp
                                @if($totalAdditional > 0)
                                <div class="p-3 bg-light d-flex justify-content-end tab-footer border-top">
                                    <div class="card-summary-premium p-3" style="width: 350px;">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span class="text-navy fw-bold text-uppercase" style="font-size: 12px; letter-spacing: 0.5px;">Total Biaya Additional</span>
                                            <span class="fs-5 fw-black text-primary">Rp {{ number_format($totalAdditional, 0, ',', '.') }}</span>
                                        </div>
                                    </div>
                                </div>
                                @endif
