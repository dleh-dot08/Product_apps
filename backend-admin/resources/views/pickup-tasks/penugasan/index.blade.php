...
<div class="card card-premium table-panel">
    <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
        <div>
            <h5 class="table-panel-title"><i class="fa-solid fa-clipboard-list me-2 text-orange"></i>Daftar Penugasan</h5>
            <div class="secondary-line mt-1">Pantau dan kelola penugasan driver.</div>
        </div>
    </div>
    
    <!-- Filter Bar inside Card Body -->
    <div class="filter-panel">
        <form action="{{ route('pickup-tasks.list-penugasan') }}" method="GET" class="row g-2 align-items-center mb-3">
            <div class="col-md-4">
            ...
            <div class="col-md-2 d-flex gap-2 filter-actions">
                ...
                <a href="{{ route('pickup-tasks.list-penugasan') }}" class="btn btn-sm btn-light border w-100 rounded-3" title="Reset"><i class="fa-solid fa-rotate-right me-1"></i> Reset</a>
            </div>
        </form>
    </div>
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="text-center empty-state">
                                ...
                                <p class="secondary-line mb-0">Tugas penugasan akan muncul di sini.</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
